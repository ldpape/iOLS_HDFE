...
{pstd} Convergence is decided based on coefficients (sum of squared coefficients < 1e-25) and not on the modulus of the contraction mapping.

{pstd} Standard Errors are consistent but will differ from those based on iOLS_OLS and will change based on the variables partialled out.
